...
// Local dev only: the "https" launch profile serves TLS from Kestrel and redirects http→https.
// Production runs behind IIS/a reverse proxy that terminates TLS, so no redirect there.

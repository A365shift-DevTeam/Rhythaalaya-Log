...
export const AddStudentModal: React.FC<AddStudentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white dark:bg-[#0f172a] rounded-2xl max-w-md w-full p-6 shadow-2xl border border-[#c7c4d7]/40 space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 font-sans text-sm">
          <div>
            ...
            <input
              ...
              className="w-full p-2.5 bg-[#f8f9ff] dark:bg-[#1e293b] border border-[#c7c4d7] rounded-xl text-[#0b1c30] dark:text-[#f8fafc] focus:outline-none focus:border-[#4648d4]"
            />
          </div>
